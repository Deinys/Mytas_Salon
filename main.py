...
pago_efect_bolivares_label.place(x=100, y=200)
pago_pgmovil_bolivares_label = Label(text="Pago Movil en Bolivares", font=40)
pago_pgmovil_bolivares_label.place(x=100, y=250)
pago_ptventas_bolivares_label = Label(text="Pago Punto de ventas en Bolivares", font=40)
pago_ptventas_bolivares_label.place(x=100, y=300)
pago_efect_dolares_label = Label(text="Pago Efectivo Dolares", font=40)
pago_efect_dolares_label.place(x=100, y=350)
monto_total_bolivares_label = Label(text="Monto Total Bolivares", font=40)
monto_total_bolivares_label.place(x=600, y=200)
monto_total_bolivares = Label(font=40)
monto_total_bolivares.place(x=900, y=200)
monto_total_dolares_label = Label(text="Monto Total Dolares", font=40)
monto_total_dolares_label.place(x=600, y=250)
monto_total_dolares = Label(font=40)
monto_total_dolares.place(x=900, y=250)
vuelto_bolivares_label = Label(text="Vuelto Bolivares", font=40)
vuelto_bolivares_label.place(x=600, y=300)
vuelto_dolares_label = Label(text="Vuelto Dolares", font=40)
vuelto_dolares_label.place(x=600, y=350)
valor_dolar_label = Label(text="Cotizacion del Dolar", font=40)
valor_dolar_label.place(x=100, y=400)

# buttons
proc_button = Button(root, text="Procesar", font="40", bg="blue")
proc_button.place(x=300, y=700)
calc_button = Button(root, text="Calcular", font="40", bg="green", command=totalbolivares)
calc_button.place(x=500, y=700)
